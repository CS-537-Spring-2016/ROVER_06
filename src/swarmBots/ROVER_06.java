...
public class ROVER_06 {
    ...
    public ROVER_06() {
        ...
        /*
         * this should be a safe but slow timer value in milliseconds - smaller
         * is faster, but the server will cut connection if it is too small
         */
        sleepTime = 300;
    }
    ...
    private void run() throws IOException, InterruptedException {
        ...
        /*
         * Make connection and initialize streams TODO - need to close this
         * socket set port here
         */
